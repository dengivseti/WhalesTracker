    ...
    return (
        <>
            ...
            >
                ...
                <Tab label="Countries" disabled={loading} {...a11yProps('country')}/>
                <Tab label="Devices" disabled={loading} {...a11yProps('device')}/>
                <Tab label="Queries" disabled={loading} {...a11yProps('query')}/>
            </Tabs>
            <TabStatistic/>
        </>
    );
