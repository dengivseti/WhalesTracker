...
export const groupReducer = (state: IGroupState, action: ActionGroup) => {
    switch (action.type) {
        case 'START_LOADING':
        ...
        case 'ADD_GROUP':
            return {...state, groups: [...state.groups, action.group], group: action.group, loading: false}
        case 'ERROR':
        ...
        case 'ADD_STREAM':
            return {...state, streams: [...state.streams, action.stream], stream: action.stream, loading: false}
        case 'SORTED_STREAMS':
            return {...state, streams: action.streams}
        case 'UPDATE_STREAMS':
            return {...state, streams: action.streams}
        ...
        case 'ADD_FILTER':
            return {...state, filters: [...state.filters, action.filter], filter: null}
        case 'CLEAR_FILTER':
            return {...state, filter: null}
        case 'UPDATE_FILTER':
            return {...state, filter: action.filter}
        case 'UPDATE_FILTERS':
            return {...state, filters: action.filters, streams: action.streams}
        case 'EDIT_FILTER':
        ...
        case 'SAVE_EDIT_GROUP':
            return {...state, loading: false, group: null, streams: [], filters: [], stream: null, filter: null}
        case 'REMOVE_STREAM':
            return {...state, streams: action.streams}
        default:
            return state
