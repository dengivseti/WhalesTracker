...
import {AppBar, CssBaseline, Divider, Drawer, Fab, IconButton, List, Toolbar, Typography} from "@material-ui/core"
...
export const Layout: React.FC = (props) => {
    ...
    const {loading, groups, fetchGroups} = useContext(GroupContext)
