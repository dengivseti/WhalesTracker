...
import {Button, TextField, Typography, Select, InputLabel, FormControl} from "@material-ui/core";
...
export const FieldCode: React.FC<IFieldProps> = (props) => {
    ...
    if (type === 'select') {
        if (!offers.length){
            return <Typography style={{margin: '2rem'}}>Add offer on {<Button href='/offers' variant='text'>Offer Page</Button>}</Typography>
        }
        return (
