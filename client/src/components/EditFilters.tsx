...
export const EditFilters: React.FC = () => {
    const {filter, filters, findFilter, stream, updateFilters, editPositionFilters, removeFilter} = useContext(GroupContext)
    ...
    useEffect(() => {setItems(filters)}, [filters.length])
