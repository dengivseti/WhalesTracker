...
export const MenuStatistic: React.FC = () => {
  ...
  const [dateStart, setDateStart] = useState<Date | null>(
    menu.startDate ? menu.startDate : new Date(),
  )
  const [dateEnd, setDateEnd] = useState<Date | null>(
    menu.endDate ? menu.endDate : new Date(),
  )
  const [interval, setInterval] = useState<typeInterval>(
    menu.interval ? menu.interval : 'today',
  )
