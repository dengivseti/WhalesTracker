        ...
        <FormControl className={classes.formControl}>
          ...
          <Select
            ...
            onChange={(
              ...
              setTypeRedirect(event.target.value as typeRedirectValue)
            }
            inputProps={{
              name: 'typeRedirect',
              id: 'typeRedirect',
