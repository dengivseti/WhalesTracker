...
export const listTypeRedirect: IValueTypeRedirect[] = [
    ...
    {value: 'iframe', name: 'Iframe', description: 'Input URL', disabled: false},
    {value: 'iframe_redirect', name: 'Iframe Redirect', description: 'Input URL', disabled: false},
    {value: 'iframe_selection', name: 'Iframe Selection', description: 'Input URL', disabled: false},
    {value: 'meta_refresh', name: 'Meta Redirect', description: 'Input URL', disabled: false},
    {value: 'javascript', name: 'JavaScript', description: 'Input JavaScript code', disabled: false},
